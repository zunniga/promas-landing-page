      ...
      {diplomas && Array.isArray(diplomas) && diplomas.length > 0 ? (
        diplomas.map((diploma, index) => {
          ...
          return (
            ...
            >
              {/* Glow effect - improved light mode colors */}
              ...
              <div className="relative bg-white dark:bg-[#101424] rounded-3xl overflow-hidden border border-slate-200 dark:border-gray-700 hover:border-[#CF0072]/30 dark:hover:border-[#360b7f]/50 transition-all duration-500 hover:shadow-2xl h-full flex flex-col backdrop-blur-sm">
                {/* Imagen - altura fija */}
                <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-[#E82769]/5 to-[#360b7f]/5 dark:from-[#101424] dark:to-[#101424] flex-shrink-0">
                  <Image
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="font-black text-xl text-slate-800 dark:text-white mb-4 group-hover:text-[#680080] dark:group-hover:text-[#E82769] transition-colors duration-300 leading-tight min-h-[3.5rem] flex items-start">
                    {diploma.name}
                  </h3>
                    ...
                    <div className="border-t border-slate-200 dark:border-gray-700 pt-4">
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <CreditCard className="h-4 w-4 text-[#CF0072]" />
                          <span className="text-sm font-medium text-slate-600 dark:text-gray-400">Desde</span>
                        </div>
                      ...
                      <div className="flex items-baseline justify-between mb-4">
                        ...
                        <span className="text-sm text-slate-500 dark:text-gray-400">Total: {priceData.totalPrice}</span>
                      </div>
...
bg-[#CF0072] hover:bg-[#90007e]
dark:bg-[#b40264] dark:hover:bg-[#680080]/90 font-bold px-6 py-3 rounded-xl transition-all duration-300 flex items-center shadow-lg hover:shadow-xl group/link transform hover:scale-105 text-sm w-full justify-center"
                      >
                        Ver diplomado
